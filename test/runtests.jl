...
# !!! Main.UserApp is configured as an alias for Main.GojuMan and you might encounter it in some tests
using Main.GojuMan, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "GojuMan tests" begin
  @includetests ARGS
end
